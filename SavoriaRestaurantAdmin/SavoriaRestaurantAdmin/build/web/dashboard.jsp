...
<head>
  <title>Home | Savoria Dashboard</title>
  <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast=""
  ...
  <nav class="pc-sidebar">
    <div class="navbar-wrapper">
      <div class="m-header">
        <a href="index.jsp.html" class="b-brand text-primary">
      ...
      <div class="navbar-content">
        ...
        <ul class="pc-navbar">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="index.jsp.html">Default</a></li>
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/demo/layout-2.html">Layouts 2</a>
              </li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/demo/layout-compact.html">Compact</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/demo/layout-tab.html">Tab</a></li>
            </ul>
          </li>
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/widget/w_statistics.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/widget/w_data.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/elements/bc_alert.html" class="pc-link" target="_blank"><span
                class="pc-micon">
                <svg class="pc-icon">
                  <use xlink:href="#custom-box-1"></use>
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/elements/animation.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/elements/icon-fontawesome.html">Font
                  Awesome 5</a></li>
              <li class="pc-item"><a class="pc-link"
          ...
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link">
              ...
              <span class="pc-mtext">Forms Elements</span><span class="pc-arrow"><i
                  data-feather="chevron-right"></i></span></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form_elements.html">Form
                  Basic</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form_floating.html">Form
                  Floating</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_basic.html">Form
                  Options</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_input_group.html">Input
                  Groups</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/forms/form2_checkbox.html">Checkbox</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_radio.html">Radio</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_switch.html">Switch</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_megaoption.html">Mega
                  option</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  <li class="pc-item"><a class="pc-link"
                      href="https://ableproadmin.com/forms/form2_datepicker.html">Datepicker</a></li>
                  <li class="pc-item"><a class="pc-link"
                      href="https://ableproadmin.com/forms/form2_daterangepicker.html">Date Range Picker</a> </li>
                  <li class="pc-item"><a class="pc-link"
                      href="https://ableproadmin.com/forms/form2_timepicker.html">Timepicker</a></li>
                </ul>
              </li>
              <li class="pc-item pc-hasmenu">
              ...
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_rating.html">Rating</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_recaptcha.html">Google
                  reCaptcha</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_inputmask.html">Input
                  Masks</a></li>
              <li class="pc-item"><a class="pc-link"
              ...
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_switchjs.html">Bootstrap
                  Switch</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_switchjs.html">Bootstrap
                  Switch</a></li>
              <li class="pc-item"><a class="pc-link"
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_quill.html">Quill</a>
              </li>
              <li class="pc-item pc-hasmenu">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/forms/form2_lay-multicolumn.html">Multicolumn</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/forms/form2_lay-actionbars.html">Actionbars</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/forms/form2_lay-stickyactionbars.html">Sticky Action bars</a> </li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link">
              ...
              <span class="pc-mtext">File upload</span><span class="pc-arrow"><i
                  data-feather="chevron-right"></i></span></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/file-upload.html">Dropzone</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/forms/form2_flu-uppy.html">Uppy</a>
              </li>
            </ul>
          </li>
          <li class="pc-item">
            <a href="https://ableproadmin.com/forms/form2_wizard.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/forms/form-validation.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item"><a href="https://ableproadmin.com/forms/image_crop.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link">
              ...
              <span class="pc-mtext">Bootstrap Table</span><span class="pc-arrow"><i
                  data-feather="chevron-right"></i></span></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_bootstrap.html">Basic
                  table</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_sizing.html">Sizing
                  table</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_border.html">Border
                  table</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_styling.html">Styling
                  table</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link">
              ...
              <span class="pc-mtext">Vanilla Table</span><span class="pc-arrow"><i
                  data-feather="chevron-right"></i></span></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_dt-simple.html">Basic
                  initialization</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-dynamic-import.html">Dynamic Import</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-render-column-cells.html">Render Column Cells</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-column-manipulation.html">Column Manipulation</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-datetime-sorting.html">Datetime Sorting</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-methods.html">Methods</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_dt-add-rows.html">Add
                  Rows</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_dt-fetch-api.html">Fetch
                  API</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/tbl_dt-filters.html">Filters</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/tbl_dt-export.html">Export</a>
              </li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link">
              ...
              <span class="pc-mtext">Data table</span><span class="pc-arrow"><i
                  data-feather="chevron-right"></i></span></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_advance.html">Advance
                  initialization</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_styling.html">Styling</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_api.html">API</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_plugin.html">Plug-in</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_sources.html">Data
                  sources</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  <li class="pc-item"><a class="pc-link"
                      href="https://ableproadmin.com/table/dt_ext_basic_buttons.html">Basic button</a></li>
                  <li class="pc-item"><a class="pc-link"
                      href="https://ableproadmin.com/table/dt_ext_export_buttons.html">Data export</a></li>
                </ul>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_ext_col_reorder.html">Col
                  reorder</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/dt_ext_fixed_columns.html">Fixed columns</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/dt_ext_fixed_header.html">Fixed header</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_ext_key_table.html">Key
                  table</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/dt_ext_responsive.html">Responsive</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_ext_row_reorder.html">Row
                  reorder</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/table/dt_ext_scroller.html">Scroller</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_ext_select.html">Select
                  table</a></li>
            </ul>
          </li>
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/chart/chart-apex.html">Apex
                  Chart</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/chart/chart-peity.html">Peity
                  Chart</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/chart/map-vector.html">Vector
                  Maps</a></li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/chart/map-gmap.html">Gmaps</a></li>
            </ul>
          </li>
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/application/calendar.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/application/chat.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/application/cust_customer_list.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/application/ecom_product-details.html">Product details</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/application/ecom_product-list.html">Product List</a></li>
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/application/ecom_product-add.html">Add New Product</a></li>
              <li class="pc-item"><a class="pc-link"
          ...
          <li class="pc-item">
            <a href="https://ableproadmin.com/application/mail.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link"
                  href="https://ableproadmin.com/application/account-profile.html">Account Profile</a></li>
              <li class="pc-item"><a class="pc-link"
            ...
            <ul class="pc-submenu">
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  ...
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/forgot-password-v1.html">Forgot Password</a></li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/check-mail-v1.html">check mail</a></li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/reset-password-v1.html">reset password</a> </li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/code-verification-v1.html">code verification</a></li>
                </ul>
              </li>
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  ...
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/forgot-password-v2.html">Forgot password</a> </li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/check-mail-v2.html">check mail</a></li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/reset-password-v2.html">reset password</a> </li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/code-verification-v2.html">code verification</a></li>
                </ul>
              </li>
              <li class="pc-item">
                <a href="https://ableproadmin.com/pages/login-v3.html" target="_blank" class="pc-link">Authentication
                  3</a>
              </li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/under-construction-v1.html">Under Construction 1</a></li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/under-construction-v2.html">Under Construction 2</a></li>
                </ul>
              </li>
              <li class="pc-item pc-hasmenu">
                ...
                <ul class="pc-submenu">
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/coming-soon-v1.html">Coming soon 1</a> </li>
                  <li class="pc-item"><a class="pc-link" target="_blank"
                      href="https://ableproadmin.com/pages/coming-soon-v2.html">Coming soon 2</a> </li>
                </ul>
              </li>
            </ul>
          </li>
          <li class="pc-item"><a href="https://ableproadmin.com/pages/contact-us.html" class="pc-link" target="_blank">
              <span class="pc-micon">
                <svg class="pc-icon">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/pages/price-v1.html">Price 1</a>
              </li>
              <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/pages/price-v2.html">Price 2</a>
              </li>
            </ul>
          </li>
          ...
          <li class="pc-item"><a href="https://ableproadmin.com/other/sample-page.html" class="pc-link">
              <span class="pc-micon">
                <svg class="pc-icon">
                  <use xlink:href="#custom-notification-status"></use>
                </svg>
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <div class="avtar avtar-s bg-light-success">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8 2V5" stroke="#2ca87f" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
                      ...
                      <path
                        ...
                        stroke="#2ca87f" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round" />
              ...
              <div class="col-6">
                <div class="d-grid">
                  <button class="preset-btn btn-img btn active" data-value="true"
                    ...
                    <img src="https://ableproadmin.com/assets/images/customizer/caption-on.svg" alt="img"
                      class="img-fluid">
                  </button>
                </div>
              </div>
              <div class="col-6">
                <div class="d-grid">
                  <button class="preset-btn btn-img btn" data-value="false" onclick="layout_caption_change('false');"
                    ...
                    <img src="https://ableproadmin.com/assets/images/customizer/caption-off.svg" alt="img"
                      class="img-fluid">
                  </button>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="d-grid">
                    <button class="preset-btn btn-img btn" data-value="true" onclick="change_box_container('true')"
                      ...
                      <img src="https://ableproadmin.com/assets/images/customizer/fixed.svg" alt="img"
                        class="img-fluid">
                    </button>
                  </div>
                </div>
...
<!-- Mirrored from ableproadmin.com/dashboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Mar 2024 07:42:24 GMT -->
