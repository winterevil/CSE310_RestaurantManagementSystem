...
<head>
  ...
  <title>Savoria Edit Product</title>
              ...
              <form action="UpdateProduct" method="post" enctype="multipart/form-data">
                ...
                <div
                  ...
                  <div class="d-flex align-content-center flex-wrap gap-3">
                    ...
                    <button type="submit" class="btn btn-primary magic-hover magic-hover__square">Update product</button>
                  </div>
                </div>
                <div class="row">
                  <!-- First column-->
                  <div class="col-12 col-lg-8">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="mb-3">
                          <% savoria.admin.product.Menu menu=(savoria.admin.product.Menu)
                        ...
                        <div class="row mb-3">
                          <div class="col">
                            ...
                            <input type="number" class="form-control" id="ecommerce-product-sku" placeholder="SKU"
                              name="productSku" aria-label="Product SKU" value="<%=menu.getSku()%>" required>
                          </div>
                          <div class="col">
                            ...
                            <input type="number" class="form-control" id="ecommerce-product-barcode
                              placeholder=" Product quantity" name="quantity" aria-label="Product quantity"
                              value="<%=menu.getQuantity()%>" required>
                          </div>
                        </div>
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="ecommerce-product-name"
                            ...
                            aria-label="Product title" value="<%=menu.getIngredient()%>" required>
                        </div>
                        <!-- Description -->
                        <div>
                    ...
                    <div class="card mb-4">
                      <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 card-title">Media (Ignore if you don't want to change image)</h5>
                      </div>
                      <div class="card-body">
                        <div class="dropzone needsclick" id="dropzone-basic" ondragover="event.preventDefault()"
                          ...
                          <div class="dz-message needsclick">
                            ...
                            <input type="file" id="btnBrowse" class="file-input magic-hover magic-hover__square" style="display: none;"
                              onchange="window.updateFileName(this)" name="image">
                      ...
                      <div class="card-body">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control" id="ecommerce-product-price" placeholder="Price"
                            name="productPrice" aria-label="Product price" value="<%=menu.getPrice()%>" required>
                        </div>
                        <!-- Discounted Price -->
                        <!-- Instock switch -->
                        <input type="hidden" id="switchValue" name="switchValue" value="<%=menu.getStock()%>">
                      ...
                      <div class="card-body">
                        ...
                        <div class="mb-3 col ecommerce-select2-dropdown">
                          ...
                          <select id="category-org" name="category" class="select2 form-select"
                            data-placeholder="Select Category" value="<%=menu.getCategory()%>">
