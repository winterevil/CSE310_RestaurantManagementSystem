...
<head>
  ...
  <title>Savoria Order List</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-2">
                <span class="text-muted fw-light">Savoria /</span> Order List
                    ...
                    <div class="row gy-4 gy-sm-1">
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <%@ page import="savoria.admin.order.OrderManager" %>
