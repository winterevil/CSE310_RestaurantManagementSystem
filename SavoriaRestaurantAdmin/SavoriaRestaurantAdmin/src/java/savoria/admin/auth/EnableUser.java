...
public class EnableUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EnableUser</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EnableUser at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                String[] customers = request.getParameter("customer").split(",");
                System.out.println(customers.length);
                if(customers != null){
                    for(String customer : customers){
                        System.out.println(customer);
                        int customerId = Integer.parseInt(customer);
                        AccountManager.enableAccount(customerId);
                    }
                }
